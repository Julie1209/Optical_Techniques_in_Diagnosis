# -*- coding: utf-8 -*-
"""
Created on Fri Dec 15 23:25:36 2023
...
for run_index in range(run_times):
    ...
    print("R: {}, T: {}, A: {}".format(R/Tissue_model["Session"]["photon_num"], T/Tissue_model["Session"]["photon_num"], A/Tissue_model["Session"]["photon_num"]))
